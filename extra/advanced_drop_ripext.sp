...
{
    char api_request_url[256];
    Format(api_request_url, sizeof(api_request_url), "https://csgo-turkiye.com/api/csgo-items?format=json&language=%s", s_language);
    HTTPRequest  hc_request = new HTTPRequest (api_request_url);
    hc_request.Get(UpdateDropItems ,client);
}
